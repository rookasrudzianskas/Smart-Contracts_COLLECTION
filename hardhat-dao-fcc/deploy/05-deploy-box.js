...
var deployBox = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, network, deploy, log, deployer, box, boxContract, timeLock, transferTx;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    box = _a.sent();
                    log("Box at ".concat(box.address));
                    if (!(!helper_hardhat_config_1.developmentChains.includes(network.name) && process.env.ETHERSCAN_API_KEY)) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, helper_functions_1["default"])(box.address, [])];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [4 /*yield*/, hardhat_1.ethers.getContractAt("Box", box.address)];
                case 5:
                    boxContract = _a.sent();
                    return [4 /*yield*/, hardhat_1.ethers.getContract("TimeLock")];
                case 6:
                    timeLock = _a.sent();
                    return [4 /*yield*/, boxContract.transferOwnership(timeLock.address)];
                case 7:
                    transferTx = _a.sent();
                    return [4 /*yield*/, transferTx.wait(1)];
                case 8:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports["default"] = deployBox;
deployBox.tags = ["all", "box"];
//# sourceMappingURL=05-deploy-box.js.map